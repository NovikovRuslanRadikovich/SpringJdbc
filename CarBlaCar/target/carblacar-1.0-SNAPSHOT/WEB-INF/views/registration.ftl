...
<div class="container">
    ...
    <sf:form name="user" action="/registration" method="POST" enctype="multipart/form-data" modelAttribute="user">
        <div class="form-group row">
            <label for="nickname" class="col-sm-2 col-form-label">Никнейм</label>
            <div class="col-sm-10">
                <input name="nickname" type="text" class="form-control" id="nickname" placeholder="Никнейм"/>
            </div>
        </div>
        <div class="form-group row">
